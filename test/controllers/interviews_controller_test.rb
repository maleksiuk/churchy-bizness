...
class InterviewsControllerTest < ActionController::TestCase
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post :create, interview: { interview_datetime: @interview.interview_datetime, position_id: @interview.position_id }
    end
  ...
  test "should update interview" do
    patch :update, id: @interview, interview: { interview_datetime: @interview.interview_datetime, position_id: @interview.position_id }
    assert_redirected_to interview_path(assigns(:interview))
  end
